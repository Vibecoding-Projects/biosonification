...
Веб-форма принимает только данные в формате FASTA: первая непустая строка должна быть заголовком, начинающимся с `>`, а затем должны идти строки последовательности. Структурированный кодировщик `v2` принимает последовательности ДНК, РНК и белок-подобные последовательности. Минимальная длина очищенной последовательности для конфигурации по умолчанию составляет 90 символов.
